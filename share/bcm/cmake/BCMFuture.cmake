...
if(WIN32)
    if(NOT COMMAND bcm_add_rpath)
        file(WRITE ${CMAKE_BINARY_DIR}/bcm_set_rpath_pre.cmake "")
        file(GENERATE OUTPUT ${CMAKE_BINARY_DIR}/bcm_set_rpath.cmake INPUT ${CMAKE_BINARY_DIR}/bcm_set_rpath_pre.cmake)
        function(bcm_add_rpath)
            foreach(RPATH ${ARGN})
                file(APPEND ${CMAKE_BINARY_DIR}/bcm_set_rpath_pre.cmake "set(ENV{PATH} \"${RPATH};\$ENV{PATH}\")\n")
            endforeach()
        endfunction()
    endif()
endif()
